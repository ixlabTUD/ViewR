...
namespace ViewR.Core.Calibration
{
    ...
    {
        private const float MaxNorth = 15;
        ...
        public Transform controllerCalibrationPointLeft;
        public Transform controllerCalibrationPointRight;
        ...
        [HideInInspector] public List<Transform> sourceTransforms = new();
            ...
            CalibrationStation calibrationStation = null)
        {
            ...
            // {
            // }
            // else if (OVRInput.GetActiveController() is OVRInput.Controller.Hands or OVRInput.Controller.LHand
            //          or OVRInput.Controller.RHand)
            // {
            // }
            // else if (OVRInput.GetActiveController() is OVRInput.Controller.None or OVRInput.Controller.Remote
            //          or OVRInput.Controller.Gamepad or OVRInput.Controller.Active or OVRInput.Controller.All)
            // {
            // }
            // else
            // {
        ...
        private CalibrationSocketOrientation GetCurrentControllersOrientation()
        {
            ...
            // if ((rotL < MaxNorth || rotL > 360 - MaxNorth) && (rotR < MaxNorth || rotR > 360 - MaxNorth))
            // {
            //     
            // }
